...
/**
 * Shared campaign-detail body. Used inside the home Modal and on the public
 * /campaigns/[id] page. Hero overlay chrome (close / share / open-in-page) is
 * owned by the parent wrapper; this component only renders the cover + body.
 */
export default function CampaignDetail({ c }: { c: CampaignView }) {
      ...
      <div className="px-5 sm:px-6 pt-4 pb-8">
        ...
        <div className="mt-4 flex items-center gap-3">
          <Link
            ...
            className="btn-join inline-flex items-center text-[13.5px] font-semibold rounded-full px-5 py-2 transition"
          >
        ...
        <Section title={t("modal.resources")}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {resources.map((r, i) => (
              <div key={i} className="pill-glass rounded-2xl p-3.5 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[11.5px] text-black/55 truncate">{r.subtitle}</div>
                </div>
                <button
                  type="button"
